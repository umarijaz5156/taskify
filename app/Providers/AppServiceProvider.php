...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        try {
            ...
            $data = ['general_settings' => $general_settings, 'email_settings' => $email_settings, 'pusher_settings' => $pusher_settings, 'languages' => $languages, 'js_date_format' => $js_date_format, 'php_date_format' => $php_date_format, 'statuses' => $statuses, 'tags' => $tags];
            view()->share($data);
