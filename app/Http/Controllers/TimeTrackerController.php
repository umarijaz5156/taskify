...
class TimeTrackerController extends Controller
{
    ...
    {
        $timesheet = $this->user->hasRole('admin') ? $this->workspace->timesheets : $this->user->timesheets;
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Timer has been started successfully.', 'recorded_id' => $recorded_id]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Timer has been stopped successfully.']);
    }
    ...
    public function destroy($id)
    {
        ...
        $response = DeletionService::delete(TimeTracker::class, $id, 'Record');
        return $response;
    }
}
