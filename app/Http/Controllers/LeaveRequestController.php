...
class LeaveRequestController extends Controller
{
    ...
    {
        $leave_requests = $this->user->hasRole('admin') ? $this->workspace->leave_requests() : $this->user->leave_requests();
    ...
    public function store(Request $request)
    {
        ...
        if (LeaveRequest::create($formFields)) {
            Session::flash('message', 'Leave request created successfully.');
            return response()->json(['error' => false, 'message' => 'Leave request created successfully.']);
        } else {
    ...
    public function destroy_multiple(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Leave request(s) deleted successfully.']);
    }
}
