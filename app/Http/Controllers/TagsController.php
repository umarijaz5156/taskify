...
class TagsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Tag created successfully.']);
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($tag->update($formFields)) {
            return response()->json(['error' => false, 'message' => 'Tag updated successfully.']);
        } else {
    ...
    public function destroy_multiple(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Tag(s) deleted successfully.']);
    }
}
