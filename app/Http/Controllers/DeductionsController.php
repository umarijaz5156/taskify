...
class DeductionsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Deduction::create($formFields)) {
            Session::flash('message', 'Deduction created successfully.');
            return response()->json(['error' => false, 'message' => 'Deduction created successfully.']);
        } else {
    ...
    public function update(Request $request)
    {
        ...
        if ($deduction->update($formFields)) {
            return response()->json(['error' => false, 'message' => 'Deduction updated successfully.']);
        } else {
    ...
    public function destroy_multiple(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Deduction(s) deleted successfully.']);
    }
}
