...
class WorkspacesController extends Controller
{
    ...
    public function list()
    {
        ...
        $workspaces = $this->user->hasRole('admin') ? $this->workspace : $this->user->workspaces();
    ...
    public function destroy($id)
    {
        if ($this->workspace->id != $id) {
            ...
            Session::flash('error', 'Current workspace couldn\'t deleted.');
    ...
    public function destroy_multiple(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Workspace(s) deleted successfully.']);
    }
    ...
    public function duplicate($id)
    {
        ...
        if (!$duplicate) {
            if (request()->has('reload') && request()->input('reload') === 'true') {
                Session::flash('error', 'Workspace duplication failed.');
            }
        ...
        return response()->json(['error' => false, 'message' => 'Workspace duplicated successfully.']);
    }
}
