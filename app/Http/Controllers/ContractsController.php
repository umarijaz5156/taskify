...
class ContractsController extends Controller
{
    ...
    {
        $contracts = $this->user->hasRole('admin') ? $this->workspace->contracts() : $this->user->contracts();
    ...
    public function list()
    {
        ...
        if ($this->user->hasRole('client')) {
            $contracts = $contracts->where('contracts.client_id',  $this->user->id)
                ->orWhere('contracts.created_by', 'c_' . $this->user->id);
        } elseif (!$this->user->hasRole('admin')) {
            $where['contracts.created_by'] = 'u_' . $this->user->id;
        }
    ...
    public function duplicate($id)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Contract duplicated successfully.']);
    }
    ...
    public function create_sign(Request $request)
    {
        ...
        if (($this->user->id == $contract->created_by || $this->user->hasRole('admin')) && !$this->user->hasRole('client')) {
    ...
    public function destroy_multiple(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Contract(s) deleted successfully.']);
    }
    ...
    public function store_contract_type(Request $request)
    {
        ...
        if (ContractType::create($formFields)) {            
            return response()->json(['error' => false, 'message' => 'Contract type created successfully.']);
        } else {
    ...
    public function update_contract_type(Request $request)
    {
        ...
        if ($ct->update($formFields)) {
            return response()->json(['error' => false, 'message' => 'Contract type updated successfully.']);
        } else {
    ...
    public function delete_multiple_contract_type(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Contract type(s) deleted successfully.']);
    }
}
