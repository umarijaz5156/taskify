...
class StatusController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Status::create($formFields)) {
            return response()->json(['error' => false,'message'=>'Status created successfully.']);
        } else {
    ...
    public function destroy_multiple(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Status(s) deleted successfully.']);
    }
}
