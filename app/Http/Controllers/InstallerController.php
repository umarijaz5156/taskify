    ...
    public function install(Request $request)
    {
        ...
        if (file_exists($sqlDumpPath)) {
            ...
            if ($user) {
                ...
                Session::flash('message', 'Congratulations! Installation completed successfully.');
                return response()->json(['error' => false]);
            } else {
                Session::flash('error', 'Oops! Installation failed. Please try again.');
                return response()->json(['error' => true, 'message' => 'Oops! Installation failed. Please try again.']);
            }
        } else {
            Session::flash('error', 'Oops! Installation couldn\'t process.');
