...
class AllowancesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Allowance::create($formFields)) {
            Session::flash('message', 'Allowance created successfully.');
            return response()->json(['error' => false, 'message' => 'Allowance created successfully.']);
        } else {
    ...
    public function update(Request $request)
    {
        ...
        if ($allowance->update($formFields)) {
            return response()->json(['error' => false, 'message' => 'Allowance updated successfully.']);
        } else {
    ...
    public function destroy_multiple(Request $request)
    {
        ...
        return response()->json(['error' => false, 'message' => 'Allowance(s) deleted successfully.']);
    }
}
