...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme menu-container">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Request::is('planss') ? 'active' : '' }}">
            <a href="/planss" class="menu-link">
                <i class='menu-icon tf-icons bx bx-grid-small text-secondary'></i>
        ...
        <li class="menu-item {{ Request::is('plans') || Request::is('plans/*') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ Request::is('request') || Request::is('request/*') ? 'active' : '' }}">
            <a href="/request" class="menu-link">
                <i class="menu-icon tf-icons bx bx-calendar text-primary"></i>
                <div><?= get_label('plans', 'Plans Request') ?></div>
            </a>
        </li>
        ...
        <li class="menu-item {{ Request::is('contracts') || Request::is('contracts/*') || Request::is('contract-types') ? 'active open' : '' }}">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-news text-success"></i>
                <?= get_label('contracts', 'Contracts') ?>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('contracts') || Request::is('contracts/*') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ Request::is('payslips') || Request::is('payslips/*') || Request::is('payment-methods') || Request::is('allowances') || Request::is('deductions') ? 'active open' : '' }}">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ Request::is('settings/system-updater') ? 'active' : '' }}">
                    <a href="/settings/system-updater" class="menu-link">
                        ...
                        &nbsp;<span class="badge bg-primary">{{get_current_version()}}</span>
                    </a>
                </li>
