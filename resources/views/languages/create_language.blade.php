            ...
            <form action="{{url('/settings/languages/store')}}" method="POST">
                ...
                <div class="row">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="name" name="name" placeholder="For Example: English" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="mb-3">
                        <label for="code">
                            Code
                            <span class="asterisk">*</span></label>
                        <input class="form-control" type="text" id="code" name="code" placeholder="For Example: en" value="{{ old('code') }}">
                        @error('code')
                        <p class="text-danger text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
