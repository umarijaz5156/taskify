        ...
        <div class="card-body">
            <form action="{{url('/payslips/update')}}" class="form-submit-event" method="POST">
                ...
                <div class="row">
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group">
                            <select id="user_id" class="form-control" name="user_id" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input class="form-control" type="number" id="basic_salary" name="basic_salary" step="0.01" placeholder="Please enter basic salary" value="{{ old('basic_salary', $payslip->basic_salary) }}">
                        </div>
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="number" id="working_days" name="working_days" step="0.01" placeholder="Please enter working days" value="{{ old('working_days', $payslip->working_days) }}">
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    <div class="mb-3 col-md-4">
                        <label class="form-label" for="lop_days"><?= get_label('lop_days', 'Loss of pay days') ?> <span class="asterisk">*</span></label>
                        <input class="form-control" type="number" id="lop_days" name="lop_days" step="0.01" placeholder="Please enter loss of pay days" value="{{ old('lop_days', $payslip->lop_days) ?? 0 }}">
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    <div class="mb-3 col-md-4">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{ $general_settings['currency_symbol'] }}</span>
                            <input class="form-control" type="number" id="bonus" name="bonus" step="0.01" placeholder="Please enter bonus" value="{{ old('bonus', $payslip->bonus) ?? 0 }}">
                        </div>
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{ $general_settings['currency_symbol'] }}</span>
                            <input class="form-control" type="number" id="incentives" name="incentives" step="0.01" placeholder="Please enter incentives" value="{{ old('incentives', $payslip->incentives) ?? 0 }}">
                        </div>
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    <div class="mb-3 col-md-4">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" id="over_time_hours" name="ot_hours" placeholder="Please enter over time hours" value="{{ old('ot_hours', $payslip->ot_hours ?? 0) }}">
                    </div>
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{ $general_settings['currency_symbol'] }}</span>
                            <input class="form-control" type="number" id="over_time_rate" name="ot_rate" step="0.01" placeholder="Please enter over time rate" value="{{ old('ot_rate', $payslip->ot_rate ?? 0) }}">
                        </div>
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    ...
                    <div class="mb-3 col-md-5">
                        ...
                        <div class="input-group">
                            <select id="allowance_id" name="allowance_id" class="form-control">
                                <option value=""><?= get_label('Please select', 'Please select') ?></option>
                    ...
                    <div class="mb-3 col-md-7">
                        ...
                        <div class="input-group">
                            <select id="deduction_id" name="deduction_id" class="form-control">
                                <option value=""><?= get_label('please_select', 'Please select') ?></option>
                        ...
                        <div class="col-md-5" id="payslip-allowances">
                            ...
                            <div class="d-flex">
                                <div class="mb-3 col-md-6 mx-1">
                                    ...
                                    <input type="text" id="allowance_0_title" class="form-control" placeholder="Allowance" readonly>
                                </div>
                                <div class="mb-3 col-md-4 mx-1">
                                    ...
                                    <input type="number" id="allowance_0_amount" class="form-control" placeholder="Amount" readonly>
                                </div>
                            ...
                            <div class="payslip-allowance">
                                <div class="d-flex">
                                    ...
                                    <div class="mb-3 col-md-4 mx-1">
                                        <input type="number" id="allowance_{{$displayIndex}}_amount" class="form-control" value="{{$allowance->amount}}" readonly>
                                    </div>
                                    <div class="mb-3 col-md-1 mx-1">
                        ...
                        <div class="col-md-7" id="payslip-deductions">
                            ...
                            <div class="d-flex">
                                <div class="mb-3 col-md-5 mx-1">
                                    ...
                                    <input type="text" id="deduction_0_title" class="form-control" placeholder="Deduction" readonly>
                                </div>
                                ...
                                <div class="mb-3 col-md-3 mx-1">
                                    ...
                                    <input type="number" id="deduction_0_amount" class="form-control" placeholder="Amount" readonly>
                                </div>
                                <div class="mb-3 col-md-3 mx-1">
                                    <label class="form-label text-muted" for="deduction_0_percentage"><?= get_label('percentage', 'Percentage') ?></label>
                                    <input type="number" id="deduction_0_percentage" class="form-control" placeholder="Percentage" readonly>
                                </div>
                                <div class="mb-3 col-md-1 mx-1">
                            ...
                            <div class="payslip-deduction">
                                <div class="d-flex">
                                    ...
                                    <div class="mb-3 col-md-3 mx-1">
                                        <input type="number" id="deduction_{{$displayIndex}}_amount" class="form-control" value="{{$deduction->amount}}" readonly>
                                    </div>
                                    <div class="mb-3 col-md-3 mx-1">
                    ...
                    <div class="d-flex">
                        <div class="col-md-5 mt-4">
                            <label class="form-label" for=""><?= get_label('total_allowances', 'Total allowances') ?> ({{$general_settings['currency_symbol']}}) : <span id="total_allowance">{{ $payslip->total_allowance ?? 0 }}</span></label>
                        </div>
                        <div class="col-md-7 mt-4 mx-4">
                            <label class="form-label" for=""><?= get_label('total_deductions', 'Total deductions') ?> ({{$general_settings['currency_symbol']}}) : <span id="total_deduction">{{ $payslip->total_deductions ?? 0 }}</span></label>
                        </div>
                    </div>
                    <div class="d-flex">
                ...
                <div class="mb-3 col-md-12 mt-4">
                    ...
                    <textarea class="form-control" name="note" rows="3" placeholder="Please enter note if any">{{ old('note', $payslip->note ?? '') }}</textarea>
