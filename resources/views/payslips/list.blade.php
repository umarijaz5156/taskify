                ...
                <table id="payslips_table" data-toggle="table" data-loading-template="loadingTemplate" data-url="/payslips/list" data-icons-prefix="bx" data-icons="icons" data-show-refresh="true" data-total-field="total" data-trim-on-search="false" data-data-field="rows" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-side-pagination="server" data-show-columns="true" data-pagination="true" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-query-params="queryParams">
                    <thead>
                        <tr>
                            ...
                            <th data-sortable="true" data-field="basic_salary"><?= get_label('basic_salary', 'Basic salary') ?> ({{$general_settings['currency_symbol']}})</th>
                            ...
                            <th data-sortable="true" data-field="leave_deduction" data-visible="false"><?= get_label('leave_deduction', 'Leave deduction') ?> ({{$general_settings['currency_symbol']}})</th>
                            ...
                            <th data-sortable="true" data-field="incentives" data-visible="false"><?= get_label('incentives', 'Incentives') ?> ({{$general_settings['currency_symbol']}})</th>
                            <th data-sortable="true" data-field="bonus" data-visible="false"><?= get_label('bonus', 'Bonus') ?> ({{$general_settings['currency_symbol']}})</th>
                            <th data-sortable="true" data-field="total_allowance" data-visible="false"><?= get_label('total_allowance', 'Total allowance') ?> ({{$general_settings['currency_symbol']}})</th>
                            <th data-sortable="true" data-field="total_deductions" data-visible="false"><?= get_label('total_deductions', 'Total deductions') ?> ({{$general_settings['currency_symbol']}})</th>
                            <!-- <th data-sortable="true" data-field="total_earnings" data-visible="false"><?= get_label('total_earnings', 'Total earnings') ?> ({{$general_settings['currency_symbol']}})</th> -->
                            <th data-sortable="true" data-field="net_pay"><?= get_label('net_pay', 'Net pay') ?> ({{$general_settings['currency_symbol']}})</th>
