                ...
                <div class="row">
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group">
                            <select id="" class="form-control" name="user_id" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input class="form-control" type="number" id="basic_salary" name="basic_salary" step="0.01" placeholder="Please enter basic salary" value="{{ old('basic_salary') }}">
                        </div>
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="number" id="working_days" name="working_days" step="0.01" placeholder="Please enter working days" value="{{ old('working_days') }}">
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    <div class="mb-3 col-md-4">
                        <label class="form-label" for=""><?= get_label('lop_days', 'Loss of pay days') ?> <span class="asterisk">*</span></label>
                        <input class="form-control" type="number" id="lop_days" name="lop_days" step="0.01" placeholder="Please enter loss of pay days" value="{{ old('lop_days')??0 }}">
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    <div class="mb-3 col-md-4">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{$general_settings['currency_symbol']}}</span>
                            <input class="form-control" type="number" id="bonus" name="bonus" step="0.01" placeholder="Please enter bonus" value="{{ old('bonus')??0 }}">
                        </div>
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{$general_settings['currency_symbol']}}</span>
                            <input class="form-control" type="number"  id="incentives" name="incentives" step="0.01" placeholder="Please enter incentives" value="{{ old('incentives')??0 }}">
                        </div>
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    <div class="mb-3 col-md-4">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="number" step="0.01" id="over_time_hours" name="ot_hours" placeholder="Please enter over time hours" value="{{ old('ot_hours')??0 }}">
                    </div>
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="input-group input-group-merge">
                            <span class="input-group-text">{{$general_settings['currency_symbol']}}</span>
                            <input class="form-control" type="number" id="over_time_rate" name="ot_rate" step="0.01" placeholder="Please enter over time rate" value="{{ old('ot_rate')??0 }}">
                        </div>
                        <p class="text-danger text-xs mt-1 error-message"></p>
                    </div>
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input type="text" id="payment_date" name="payment_date" class="form-control" value="" placeholder="<?= get_label('please_select', 'Please select') ?>" autocomplete="off">
                    </div>
                    <div class="mb-3 col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex">
                            <div class="col-md-5 mt-4">
                                <label class="form-label" for=""><?= get_label('total_allowances', 'Total allowances') ?> ({{$general_settings['currency_symbol']}}) : <span id="total_allowance">0</span></label>
                            </div>
                            <div class="col-md-7 mt-4 mx-4">
                                <label class="form-label" for=""><?= get_label('total_deductions', 'Total deductions') ?> ({{$general_settings['currency_symbol']}}) : <span id="total_deduction">0</span></label>
                            </div>
                        </div>
                        <div class="d-flex">
