                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <strong><?= get_label('basic_salary', 'Basic salary') ?>:</strong> {{ $general_settings['currency_symbol'] }} {{ $payslip->basic_salary }}
                            </li>
                            <li class="list-group-item">
                            ...
                            <li class="list-group-item">
                                <strong><?= get_label('leave_deduction', 'Leave deduction') ?>:</strong> {{ $general_settings['currency_symbol'] }} {{ $payslip->leave_deduction }}
                            </li>
                            <li class="list-group-item">
                                <strong><?= get_label('bonus', 'Bonus') ?>:</strong> {{ $general_settings['currency_symbol'] }} {{ $payslip->bonus }}
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-6">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <strong><?= get_label('incentives', 'Incentives') ?>:</strong> {{ $general_settings['currency_symbol'] }} {{ $payslip->incentives }}
                            </li>
                            <li class="list-group-item">
                                <strong><?= get_label('over_time_hours', 'Over time hours') ?>:</strong> {{ $payslip->ot_hours }}
                            </li>
                            <li class="list-group-item">
                                <strong><?= get_label('over_time_rate', 'Over time rate') ?>:</strong> {{ $general_settings['currency_symbol'] }} {{ $payslip->ot_rate }}
                            </li>
                            <li class="list-group-item">
                                <strong><?= get_label('over_time_payment', 'Over time payment') ?>:</strong> {{ $general_settings['currency_symbol'] }} {{ $payslip->ot_payment }}
                            </li>
                            <li class="list-group-item">
                ...
                <div class="row mt-4 mx-1">
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Amount ({{ $general_settings['currency_symbol'] }})</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $general_settings['currency_symbol'] }} {{ $allowance->amount }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th><?= get_label('amount', 'Amount') ?> ({{ $general_settings['currency_symbol'] }})</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $general_settings['currency_symbol'] }} {{ $deduction->amount }}</td>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $general_settings['currency_symbol'] }} {{ $payslip->total_allowance }}</td>
                                </tr>
                                <tr>
                                    <th scope="row"><?= get_label('total_deductions', 'Total deductions') ?></th>
                                    <td>{{ $general_settings['currency_symbol'] }} {{ $payslip->total_deductions }}</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="text-end mt-4">
                            <h5 class="d-none"><?= get_label('total_earnings', 'Total earnings') ?> : {{ $general_settings['currency_symbol'] }} {{ $payslip->total_earnings }}</h5>
                            <h5><?= get_label('net_payable', 'Net payable') ?> : {{ $general_settings['currency_symbol'] }} {{ $payslip->net_pay }}</h5>
                        </div>
                        <!-- Note -->
                        @if ($payslip->note)
                        <h5>Note</h5>
