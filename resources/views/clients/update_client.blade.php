            ...
            <form action="{{url('/clients/update/' . $client->id)}}" method="POST" class="form-submit-event" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="first_name" name="first_name" placeholder="Enter First name" value="{{ $client->first_name }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="last_name" placeholder="Enter Last name" id="last_name" value="{{ $client->last_name }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="email" name="email" placeholder="Enter E-mail" value="{{ $client->email }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" id="phone" name="phone" class="form-control" placeholder="Enter Phone number" value="{{ $client->phone }}">
                        @error('phone')
                        <p class="text-danger text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="company" name="company" placeholder="Enter Company name" value="{{ $client->company }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="address" name="address" placeholder="Enter Address" value="{{ $client->address }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="city" name="city" placeholder="Enter City" value="{{ $client->city }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="state" name="state" placeholder="Enter State" value="{{ $client->state }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="country" name="country" placeholder="Enter Country" value="{{ $client->country }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="zip" name="zip" placeholder="Enter Zip Code" value="{{ $client->zip }}">
