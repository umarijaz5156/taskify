            ...
            <div class="col-md-4 sticky-note">
                <div class="sticky-content sticky-note-bg-<?= $note->color ?>">
                    <div class="text-end">
                        ...
                        <!-- </span> -->
                        <a href="javascript:void(0);" class="btn btn-danger btn-xs mx-1 delete" data-id='{{$note->id}}' data-type='notes' data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="<?= get_label('delete', 'Delete') ?>">
                    ...
                    <b><?= get_label('created_at', 'Created at') ?> : </b><span class="text-primary">{{ format_date($note->created_at)}}</span>
                </div>
            </div>
