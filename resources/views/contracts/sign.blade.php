                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-8 text-start">
                        ...
                        <p>
                            ...
                            {{$general_settings['currency_symbol'].' '.$contract->value}}
                        </p>
                        <p>
                    ...
                    <div class="col-md-3 text-right mt-4 mb-4">
                        ...
                        @if ((getAuthenticatedUser()->id == $contract->created_by || getAuthenticatedUser()->hasRole('admin')) && !getAuthenticatedUser()->hasRole('client'))
