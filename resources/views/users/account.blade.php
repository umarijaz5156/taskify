                    ...
                    <form id="formAccountSettings" method="POST" class="form-submit-event" action="/profile/update/{{getAuthenticatedUser()->id}}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="first_name" name="first_name" placeholder="Enter first name" value="{{ getAuthenticatedUser()->first_name }}" autofocus />
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" name="last_name" placeholder="Enter last name" id="last_name" value="{{getAuthenticatedUser()->last_name}}" />
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" id="phone" name="phone" placeholder="Enter phone number" class="form-control" placeholder="" value="{{getAuthenticatedUser()->phone}}" />
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" name="email" placeholder="Enter email" value="{{getAuthenticatedUser()->email}}" @if(!getAuthenticatedUser()->hasRole('admin')) readonly @endif>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <label class="form-label" for="role"><?= get_label('role', 'Role') ?> <span class="asterisk">*</span></label>
                                <input class="form-control" type="text" id="exampleFormControlReadOnlyInput1" placeholder="" value="{{getAuthenticatedUser()->getRoleNames()->first()}}" readonly="">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="address" placeholder="Enter address" name="address" value="{{getAuthenticatedUser()->address}}">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="city" placeholder="Enter city" name="city" value="{{getAuthenticatedUser()->city}}">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="state" placeholder="Enter state" name="state" value="{{getAuthenticatedUser()->state}}">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="country" placeholder="Enter country" name="country" value="{{getAuthenticatedUser()->country}}">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control" type="text" id="zip" placeholder="Enter ZIP code" name="zip" value="{{getAuthenticatedUser()->zip}}">
