                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input class="form-control" type="text" id="dob" placeholder="" value="{{ format_date($user->dob)}}" readonly="">
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="form-label" for="doj"><?= get_label('date_of_join', 'Date of joining') ?></label>
                            <div class="input-group input-group-merge">
                                <input class="form-control" type="text" id="doj" placeholder="" value="{{ format_date($user->doj)}}" readonly="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade active show" id="navs-top-projects" role="tabpanel">
                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        <?php
                        $id = $user->hasRole('admin') ? '' : 'user_' . $user->id;
                        ?>
