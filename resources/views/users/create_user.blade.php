            ...
            <form action="{{url('/users/store')}}" method="POST" class="form-submit-event" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="last_name" id="last_name" placeholder="Enter Last name" value="{{ old('last_name') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="email" name="email" placeholder="Enter E-mail" value="{{ old('email') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="city" name="city" placeholder="Enter City" value="{{ old('city') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="state" name="state" placeholder="Enter State" value="{{ old('state') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="country" name="country" placeholder="Enter Country" value="{{ old('country') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="zip" name="zip" placeholder="Enter Zip Code" value="{{ old('zip') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="zip" class="form-label"><?= get_label('Department', 'Department') ?> <span class="asterisk">*</span></label>
                        {{-- <select class="form-select" id="department" name="department" required>
                            ...
                            <option value="Domain/Hosting/cPanel Support">Domain/Hosting/cPanel Support</option>
                            <option value="HR/Customer Support">HR/Customer Support</option>
                        </select> --}}
