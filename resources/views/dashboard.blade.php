...
<div class="container-fluid">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                ...
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="user-progress">
                                        <small class="fw-semibold"><?= $count = $auth_user->hasRole('admin') ? count($status->projects) : $auth_user->status_projects($status->id)->count(); ?></small>
                                    </div>
                        ...
                        <ul class="p-0 m-0">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                ...
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    ...
                                    <div class="user-progress">
                                        <small class="fw-semibold"><?= $count =  $auth_user->hasRole('admin') ? count($status->tasks) : $auth_user->status_tasks($status->id)->count(); ?></small>
                                    </div>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade active show" id="navs-top-projects" role="tabpanel">
                ...
                <div class="table-responsive text-nowrap">
                    ...
                    $id = $auth_user->hasRole('admin') ? '' : $type . '_' . $auth_user->id;
                    ?>
    ...
    foreach ($statuses as $status) {
        $project_count = $auth_user->hasRole('admin') ? count($status->projects) : $auth_user->status_projects($status->id)->count();
        array_push($project_counts, $project_count);

        $task_count = $auth_user->hasRole('admin') ? count($status->tasks) : $auth_user->status_tasks($status->id)->count();
