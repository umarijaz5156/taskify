            ...
            <form action="/tasks/store" class="form-submit-event" method="POST">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="title" name="title" placeholder="Enter Title" value="{{ old('title') }}">
                        @error('title')
                    ...
                    <div class="mb-3 col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-select" id="task_department" name="task_department" required>
                ...
                <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" rows="5" name="description" placeholder="Enter Description">{{ old('description') }}</textarea>
                        @error('description')
                        <p class="text-danger text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
