            ...
            <input type="hidden" name="redirect_url" value="/settings/pusher">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="pusher_app_id" placeholder="Enter pusher APP ID" value="<?= config('constants.ALLOW_MODIFICATION') === 0 ? str_repeat('*', strlen($pusher_settings['pusher_app_id'])) : $pusher_settings['pusher_app_id'] ?>">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="pusher_app_key" placeholder="Enter pusher APP key" value="<?= config('constants.ALLOW_MODIFICATION') === 0 ? str_repeat('*', strlen($pusher_settings['pusher_app_key'])) : $pusher_settings['pusher_app_key'] ?>">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="pusher_app_secret" placeholder="Enter pusher APP secret" value="<?= config('constants.ALLOW_MODIFICATION') === 0 ? str_repeat('*', strlen($pusher_settings['pusher_app_secret'])) : $pusher_settings['pusher_app_secret'] ?>">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="pusher_app_cluster" placeholder="Enter pusher APP cluster" value="<?= config('constants.ALLOW_MODIFICATION') === 0 ? str_repeat('*', strlen($pusher_settings['pusher_app_cluster'])) : $pusher_settings['pusher_app_cluster'] ?>">
