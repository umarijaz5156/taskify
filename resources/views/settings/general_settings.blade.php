            ...
            <input type="hidden" name="redirect_url" value="/settings/general">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="company_title" name="company_title" placeholder="Enter company title" value="{{ $general_settings['company_title'] }}">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="text" id="currency_full_form" name="currency_full_form" placeholder="Enter currency full form" value="{{$general_settings['currency_full_form']}}">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="text" id="currency_symbol" name="currency_symbol" placeholder="Enter currency symbol" value="{{$general_settings['currency_symbol']}}">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input class="form-control" type="text" id="currency_code" name="currency_code" placeholder="Enter currency code" value="{{$general_settings['currency_code']}}">
