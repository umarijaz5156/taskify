            ...
            <form action="{{url('/settings/store_email')}}" class="form-submit-event" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="" name="email" placeholder="Enter email" value="<?= config('constants.ALLOW_MODIFICATION') === 0 ? str_repeat('*', strlen($email_settings['email'])) : $email_settings['email'] ?>">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="password" name="password" placeholder="Enter password" value="<?= $email_settings['password'] ?>">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="" name="smtp_host" placeholder="Enter SMTP host" value="<?= $email_settings['smtp_host'] ?>">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="" name="smtp_port" placeholder="Enter SMTP port" value="<?= $email_settings['smtp_port'] ?>">
