            ...
            <div class="card mb-3">
                <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div class="input-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-item">
                                        <a href="javascript:void(0);" class="delete" data-type="projects" data-id="{{$project->id}}">
                    ...
                    <div class="my-4 d-flex justify-content-between">
                        ...
                        <span class='badge bg-label-primary me-1'> {{$general_settings['currency_symbol'].' '.$project->budget}}</span>
                        @endif
                    </div>
                    <div class="my-4 d-flex justify-content-between">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            <p class="card-text">
                                <?= get_label('Team Member', 'Team Member') ?>:
